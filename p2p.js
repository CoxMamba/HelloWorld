/**
 * Created by Madhouse on 2015/10/28.
 */
var p2p_filter = new Vue({
    ...
    data:{
        ...
        select_titles:[
            ...
            {child_title:'投资周期',child_title_bk:'投资周期',child_content:['不限','1个月以内','1-3个月','3-6个月','6个月-1年','1年以上'],ifdisplay:false,index:1,chosen:0},
            {child_title:'预期收益',child_title_bk:'预期收益',child_content:['不限','0-5%','5-10%','10-15%','15%以上'],ifdisplay:false,index:2,chosen:0}
        ]
    },
    methods:{
    ...
    for(item in wealth_result.wealth_contents){
        ...
        switch(money){
            ...
            case 1 :
                ...
                break;
            case 2 :
                if(wealth_contents.wealth_contents[item].money <=100000 && wealth_result.wealth_contents[item].money>50000) flag = true;
                break;
            case 3 :
                if(wealth_result.wealth_contents[utem].money <=200000 && wealth_result.wealth_contents[item].money>100000) flase = true;
                break;
            case 4 :
                if(wealth_result.wealth_contents[item].money <=500000 && wealth_result.wealth_contents[item].money>200000) flase = true;
                break;
            case 5 :
        ...
        if(!flag){
            wealth_contents.wealth_contents[item].ifdisplay = false;
            continue
        }
        flag = false;
        switch(time){
        ...
        if(!flag){
            wealth_result.wealth_contents[item].profit = false;
            continue;
        }
